...
function con()
{
  var youxiang=document.getElementById("m").value;
	if(youxiang.match("^\\w+@\\w+.\\w*$")&&youxiang!=""){
		document.getElementById("ms").innerHTML="";
	}
	else{
		document.getElementById("ms").innerHTML="请输入正确的邮箱";
	}
}
function con1()
{
...
function con1_(){
	...
	var password1=document.getElementById("p_").value;
	if(password.equals(password1)){
		document.getElementById("sp_").innerHTML="";
	}
	else{
		document.getElementById("sp_").innerHTML="重复密码输入错误";
	}
}
function con2()
{
...
<form action="${pageContext.request.contextPath}/login1Servlet">
<center>
<table border="0" width="80%">
  ...
  <tr><td colspan="2" width="100%"align="center">
   ...
   <div><input type="button" value="电子邮箱注册" onclick="log1();"/>
     <input type="button" value="手机号码注册" 
onclick="log2();"/></div>
  </td>
  </tr>
...
<tr><td width="80%">
    ...
    <tr><td width="60%"><lable>我的邮箱</lable><input width="80%" id="m" name="m" type="text" onblur="con();"/></td>
         <td><span id="ms" style="color:red">注册新浪邮箱</span></td>
     </tr>
...
onblur="con1();"/></td>
     ...
     <tr><td width="60%"><lable>重复密码</lable><input      
width="80%" id="p_" name="p_" type="password" 
onblur="con1()_;"/></td>
         <td><span id="sp_" style="color:red"></span></td>
     </tr>

    <tr><td width="60%"><lable>昵称</lable><input      
width="80%" id="n" name="n" type="text" 
onblur="con2();"/></td>
    ...
    <td>
     ...
     <tr><td colspan="2"><lable>学校</lable><input type="text" id="school" name="school"></td></tr>


     <tr><td width="60%"><lable>姓名</lable><input  width="80%" id="yn" name="yn" type="text" 
onblur="con3();"/></td>
         <td><span id="syn" style="color:red"></span></td>
     </tr>
...
onblur="con4();"/></td>
   ...
   <tr><td width="60%"><lable>验证码</lable><input  width="80%" id="w" type="text" 
